...
const SpecialityMenu = () => {
    ...
    return (
        <div id="speciality" className='flex flex-col items-center gap-4 py-16 text-gray-900'>
            ...
            <p className='sm:w-1/3 text-center text-sm'>Our platform connects patients with specialist doctors across various fields like cardiology, neurology, dermatology, and more for expert medical care.</p>
